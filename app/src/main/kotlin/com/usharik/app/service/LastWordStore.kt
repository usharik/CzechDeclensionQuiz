...
interface LastWordStore {
    ...
    companion object {
        ...
        val NO_OP = object : LastWordStore { override fun saveLastWord(modeKey: String, word: String) = Unit; override fun getLastWord(modeKey: String): String? = null; override fun clear(modeKey: String) = Unit }
    }
}
